    ...
    <div className="bg-white" style={{ cursor: inside ? "none" : "auto" }}>
      ...
      <div className="sticky top-0 z-50 flex justify-center px-6 pt-5 pb-3">
        <nav className="w-full flex items-center justify-between px-5 py-2.5" style={{ maxWidth: 960, borderRadius: 14, border: "1px solid rgba(0,0,0,0.08)", background: "rgba(255,255,255,0.65)", backdropFilter: "blur(28px) saturate(180%)", WebkitBackdropFilter: "blur(28px) saturate(180%)", boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}>
          <span className="text-[20px] font-semibold" style={{ fontFamily: G }}>
      ...
      <section className="px-6 pb-12">
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <div className="flex justify-center gap-2 mt-6">
            ...
            {/* Notify for Windows — disappears once pressed, tracked in localStorage */}
            {!windowsNotified && (
              <button
                onClick={() => { localStorage.setItem("windows-notify", "1"); setWindowsNotified(true); }}
                className="inline-flex items-center text-[12px] font-medium transition-all hover:border-neutral-400 hover:text-neutral-600"
                style={{
      ...
      <section className="pb-10">
        <h2 className="text-center text-[42px] leading-[1.05] tracking-[-0.015em] text-neutral-950 mb-8 mt-4 px-6" style={{ fontFamily: G, fontWeight: 500, maxWidth: 640, margin: "16px auto 32px" }}>
          Download c<span className="text-blue-500">u</span>rs<span className="text-blue-500">u</span>r to see when you will get these reactions.
        </h2>
      ...
      <footer className="border-t border-neutral-100 py-7">
        <div className="flex justify-center items-center gap-6">
          {/* X / Twitter */}
          <a href="#" aria-label="X" className="text-neutral-300 hover:text-neutral-700 transition-colors">
            <svg viewBox="0 0 24 24" style={{ width: 18, height: 18, fill: "currentColor" }}><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.259 5.629zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          {/* Instagram */}
          <a href="#" aria-label="Instagram" className="text-neutral-300 hover:text-neutral-700 transition-colors">
          ...
          {/* TikTok */}
          <a href="#" aria-label="TikTok" className="text-neutral-300 hover:text-neutral-700 transition-colors">
            <svg viewBox="0 0 24 24" style={{ width: 18, height: 18, fill: "currentColor" }}><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.17 8.17 0 004.78 1.52V6.76a4.85 4.85 0 01-1.01-.07z"/></svg>
          </a>
        </div>
      </footer>
    </div>
